  ...
  return (
    ...
    <main className="max-w-4xl mx-auto px-6 py-20">
      ...
      <div className="flex flex-col md:flex-row items-center gap-8 mb-12">
        <Image
          src="/profile.jfif" // 🔁 Make sure this is in your /public folder
          alt="Afsha Ammisetty"
          width={180}
          height={180}
        ...
        <div>
          ...
          <p className="text-gray-700 dark:text-gray-400 mb-2">
            I specialize in Front End Technologies like HTML, CSS JavaScript, React, & Nextjs etc., My recent work includes building full-stack solutions with RESTful APIs, custom admin dashboards, and interactive UIs. I've delivered responsive designs and clean code for companies like <strong>Walls Metal Roofing</strong>, <strong>Vedacations Teaching</strong> and more.
          </p>
