    ...
    <section className="mt-10 px-6 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 text-left text-gray-800">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 leading-relaxed">
            {"I started my journey as a Front-End Developer intern at Guntur Web Designing, where I learned the fundamentals of building user interfaces. Recently, I built a freelance project called "}
